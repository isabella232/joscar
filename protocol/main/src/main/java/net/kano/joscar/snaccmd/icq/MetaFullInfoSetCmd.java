    ...
    extends ToIcqCmd
{
     ...
     * @throws IOException
     */
    public void setEmail(String value, boolean publish)
        throws IOException
    {
        if(value == null)
            changeDataTlvs.add(getClearTlv(0x015E));
        else
        {
    ...
    public void setWebAware(boolean isSet)
        throws IOException
    {
    ...
    public void setAuthorization(boolean isSet)
        throws IOException
    {
    ...
    public void setLanguages(int l1, int l2, int l3)
        throws IOException
    {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
    ...
    public void setInterests(int[] categories, String[] interests)
        throws IOException
    {
    ...
    private void setInt(int code, int value)
        throws IOException
    {
        if(value == -1)
            changeDataTlvs.add(getClearTlv(code));
     ...
     * @throws IOException
     */
    private Writable getClearTlv(int type)
        throws IOException
    {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
